    ...
    <footer className="bg-gray-900 text-white py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              ...
              located across Cairo's most prestigious neighborhoods.
            </p>
            <div className="flex space-x-4">
              ...
              <a
                ...
                className="text-gray-400 hover:text-gold-DEFAULT transition-colors"
                aria-label="Facebook"
              >
                <svg
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/services" className="text-gray-400 hover:text-gold-DEFAULT transition-colors">
                  Our Services
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="h-6 w-6 mr-3 flex-shrink-0 text-gold-DEFAULT"
                >
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500">
          <p>© {currentYear} Valora. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
